...
uses
  ...
  clMailMessage, clTcpCommandServer, clMailUserMgr;
...
type
  TForm1 = class(TForm)
    ...
    procedure clReceiveCommand(Sender: TObject; AConnection: TclCommandConnection;
...
procedure TForm1.clReceiveCommand(Sender: TObject; AConnection: TclCommandConnection;
  ACommandParams: TclTcpCommandParams);
begin
...
procedure TForm1.clAcceptConnection(Sender: TObject; AConnection: TclUserConnection);
begin
    ...
    begin
      ...
      try
        repeat
          ...
          clSmtpRelay1.MailFrom := clMailMessage1.From.Email;
