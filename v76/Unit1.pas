...
uses
  ...
  clTcpCommandServer, clMailUserMgr;
      ...
      begin
        ...
        try
          repeat
            ...
            ProcessBounces(path + searchRec.Name);//BUG need to replace to ChangeFileExt(searchRec.Name, cMessageFileExt)
            DeleteFile(path + searchRec.Name); //BUG need to delete both env and msg files
